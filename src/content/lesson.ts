...
export const activityBank: Activity[] = [
  ...
  {id:'sb1',type:'sound_builder',skillId:'PA-04',title:'Sound Builder',instruction:'Tap one box for every sound you hear.',prompt:'How many sounds do you hear?',audioText:'ship',answer:'3 sounds',hint:'/sh/ is one sound. Try /sh/ /ĭ/ /p/.',difficulty:2,...meta('ship')},
  {id:'sb2',type:'sound_builder',skillId:'PA-04',title:'Sound Builder',instruction:'Tap one box for every sound you hear.',prompt:'How many sounds do you hear?',audioText:'chat',answer:'3 sounds',hint:'/ch/ /ă/ /t/ — three sounds.',difficulty:2,...meta('chat')},
  {id:'sb3',type:'sound_builder',skillId:'PA-04',title:'Sound Builder',instruction:'Tap one box for every sound you hear.',prompt:'How many sounds do you hear?',audioText:'stop',answer:'4 sounds',hint:'Stretch it: /s/ /t/ /ŏ/ /p/.',difficulty:3,...meta('stop')},
  {id:'sb4',type:'sound_builder',skillId:'PA-04',title:'Sound Builder',instruction:'Tap one box for every sound you hear.',prompt:'How many sounds do you hear?',audioText:'snap',answer:'4 sounds',hint:'Stretch it: /s/ /n/ /ă/ /p/.',difficulty:3,...meta('snap')},
  {id:'sb5',type:'sound_builder',skillId:'PA-04',title:'Sound Builder',instruction:'Tap one box for every sound you hear.',prompt:'How many sounds do you hear?',audioText:'brush',answer:'4 sounds',hint:'/b/ /r/ /ŭ/ /sh/. Remember /sh/ is one sound.',difficulty:4,...meta('brush')},
  {id:'sb6',type:'sound_builder',skillId:'PA-04',title:'Sound Builder',instruction:'Tap one box for every sound you hear.',prompt:'How many sounds do you hear?',audioText:'stamp',answer:'5 sounds',hint:'Stretch it: /s/ /t/ /ă/ /m/ /p/.',difficulty:4,...meta('stamp')},
